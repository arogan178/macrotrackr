    ...
    <div className="space-y-2">
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full ${
            icon ? "pl-10" : "px-4"
          } py-3 bg-gray-700/70 border border-gray-600/70 rounded-lg text-gray-100 
      ...
      <div className="space-y-3 mt-6">
        <div className="flex items-center p-3 rounded-lg border border-indigo-500/20 bg-indigo-500/10">
          ...
          <p className="text-sm text-indigo-300">
            Your activity level helps us calculate your daily energy
          ...
          <div className="flex-1 flex space-x-2">
            {stepInfo.map((info, idx) => (
              <div key={idx} className="flex-1 flex flex-col items-center">
                ...
                <span
                  className={`text-xs ${
                    idx + 1 === step ? "text-white" : "text-gray-400"
                  }`}
                >
                  {info.title}
                </span>
