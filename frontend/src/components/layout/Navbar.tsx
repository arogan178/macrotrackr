  ...
  return (
    <>
      <header className="fixed inset-x-0 top-4 z-50 px-4 sm:px-6 lg:px-8">
        <nav
          className="supports-backdrop-filter:bg-background/75 mx-auto flex min-h-14 w-full max-w-7xl items-center justify-between rounded-2xl border border-border/70 bg-background/85 px-4 shadow-lg shadow-black/5 backdrop-blur-md transition-colors duration-200 sm:px-6"
          role="navigation"
      ...
      <AnimatePresence initial={false}>
        {isMobileMenuOpen && (
          <>
            ...
            <motion.div
              className="supports-backdrop-filter:bg-background/80 fixed inset-x-4 top-20 z-50 rounded-2xl border border-border/70 bg-background/90 p-3 shadow-xl shadow-black/10 backdrop-blur-md lg:hidden"
