            ...
            <div className={!canAddHabit ? "relative" : ""}>
              <ProFeature>
                <button
                  ...
                  className="flex items-center text-sm text-indigo-400 hover:text-indigo-300 transition-colors bg-indigo-500/10 px-3 py-1.5 rounded-lg disabled:opacity-50 "
                >
