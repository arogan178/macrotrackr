  ...
  return (
    <section className="rounded-card border border-border bg-surface p-5 shadow-sm md:p-6">
      <button
        type="button"
        onClick={onToggle}
        className="group flex w-full items-center justify-between rounded-control px-1 py-1.5 text-left text-sm font-semibold text-foreground transition-colors hover:bg-surface-2"
      >
        <span className="flex items-center gap-3">
          <span className="flex h-9 w-9 items-center justify-center rounded-card bg-surface-2 text-muted transition-colors group-hover:text-foreground">
            <svg
              className="h-4 w-4"
              fill="none"
              stroke="currentColor"
          ...
          >
            <div className="mt-4 space-y-4">
                  ...
                  <div className="grid grid-cols-4 gap-2 md:grid-cols-7">
                    {[0.25, 0.5, 0.75, 1, 1.5, 2].map((factor) => (
                      <button
                        ...
                        className={`rounded-control px-2.5 py-2 text-center text-xs font-medium transition-[background-color,border-color,color,transform] duration-200 ${
                    ...
                    <input
                      ...
                      max={10}
                      step={0.1}
                      className="col-span-2 rounded-control border border-border bg-surface px-3 py-2 text-center text-xs font-medium text-foreground tabular-nums placeholder:text-muted/60 focus:ring-2 focus:ring-primary/40 focus:outline-none md:col-span-1"
                    />
                  </div>
                </div>
              )}
              ...
              {hasIngredients ? (
                ...
                <div className="rounded-card border border-dashed border-border bg-surface-2 py-10 text-center">
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-card border border-dashed border-border bg-surface-2 py-3.5 text-sm font-medium text-foreground transition-[background-color,border-color,color,transform] duration-200 hover:border-primary/40 hover:bg-primary/5 hover:text-primary focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:outline-none active:scale-[0.98]"
              >
                <svg
                  className="h-4 w-4"
                  fill="none"
