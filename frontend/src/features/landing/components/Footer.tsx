  ...
  <footer className="relative z-10 border-t border-border/50 py-12 px-4 sm:px-6 lg:px-8">
    <div className="max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        <div className="">
          <h3 className="text-3xl font-bold bg-gradient-to-r from-white to-surface text-transparent bg-clip-text mb-4 pb-2">
            MacroTrackr
          </h3>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-border/50">
        <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-8 text-foreground">
          <p>
