      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:gap-10">
        {features.map((feature, index) => (
          <ScrollTriggeredDiv key={feature.title} delay={0.1 + index * 0.1}>
            <div className="rounded-xl border border-border bg-surface p-8 transition-colors hover:bg-surface-2">
              <div className="relative">
                <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-xl border border-border bg-surface-2">
