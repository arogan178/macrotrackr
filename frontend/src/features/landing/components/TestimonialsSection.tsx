      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {testimonials.map((testimonial, index) => (
          <ScrollTriggeredDiv key={testimonial.name} delay={0.1 + index * 0.1}>
            <div className="bg-surface/50 backdrop-blur-sm border border-border/50 rounded-2xl p-8 hover:bg-surface/70 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-modal hover:shadow-primary/10">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <div className="text-foreground">{testimonial.title}</div>
                </div>
              </div>
            </div>
          </ScrollTriggeredDiv>
