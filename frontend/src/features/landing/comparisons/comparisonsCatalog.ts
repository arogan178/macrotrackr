...
export const MASTER_COMPARISON_MATRIX: readonly MasterComparisonRow[] = [
  {
    ...
    macrotrackr: "Free Self-Hosted / $3.99/mo Cloud",
    myfitnesspal: "$19.99/mo Premium",
    macrofactor: "$11.99/mo (No free tier)",
    cronometer: "Free / $9.99/mo Gold",
    loseIt: "Free / $39.99/yr Premium",
    highlight: true,
  },
  {
    feature: "Barcode Scanner",
    macrotrackr: "Free (OpenFoodFacts)",
    myfitnesspal: "Paywalled ($19.99/mo)",
    macrofactor: "Included ($11.99/mo)",
    cronometer: "Free",
    loseIt: "Free",
    highlight: true,
  },
