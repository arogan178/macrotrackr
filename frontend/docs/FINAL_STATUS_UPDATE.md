...
<Button autoLoadingFeature="newFeature" onClick={handleAction}>
  New Action
</Button>
```
...
3. **MacroTargetForm** - Update Button with auto-loading
...
- ✅ **Enhanced Button** with automatic loading detection
