...
const routes = [
  ...
  { path: "/compare/myfitnesspal-alternative", changefreq: "weekly", priority: 0.8 },
  { path: "/compare/macrofactor-alternative", changefreq: "weekly", priority: 0.7 },
  { path: "/compare/cronometer-alternative", changefreq: "weekly", priority: 0.7 },
  { path: "/compare/lose-it-alternative", changefreq: "weekly", priority: 0.7 },
